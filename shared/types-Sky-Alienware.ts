export interface User {
   ...
   * - idDocumentUrl: URL to uploaded ID/Passport document
   * - idDocumentType: Type of document uploaded
   * - verificationStatus: Current verification status
   * - verifiedAt: When the user was verified by admin
   * - verifiedBy: Admin ID who verified the user
   */
